...
function CategoryTitle({ category, index, setActiveIndex }: { category: typeof categories[0], index: number, setActiveIndex: (i: number) => void }) {
  ...
  return (
    <div ref={ref} className="h-[25vh] md:h-[30vh] flex items-center">
      <motion.h2 
        animate={{ 
          color: isInView ? "rgba(255, 255, 255, 1)" : "rgba(255, 255, 255, 0.15)",
    ...
    <section className="relative bg-black w-full" style={{ height: `${categories.length * 30 + 100}vh` }}>
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex">
        ...
        <div className="absolute inset-0 max-w-[1400px] mx-auto px-6 md:px-12 flex pt-24 md:pt-32 pointer-events-none">
          ...
          <div className="w-[45%] lg:w-1/2 flex flex-col pointer-events-auto">
          ...
          <div className="w-[55%] lg:w-1/2 h-full flex flex-col justify-center pb-32 pointer-events-auto pl-8">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex h-full">
          ...
          <div className="w-[45%] lg:w-1/2 pointer-events-auto mt-[40vh]">
            {categories.map((c, i) => (
              <CategoryTitle key={c.id} index={i} category={c} setActiveIndex={setActiveIndex} />
            ))}
