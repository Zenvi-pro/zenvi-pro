...
export function N8nWorkflowBlock() {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden flex flex-col p-4 sm:p-6">
      {/* Header */}
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 relative z-10">
      ...
      <div
        ref={canvasRef}
        className="relative flex-1 w-full overflow-auto rounded-xl sm:h-[500px] md:h-[600px] pointer-events-auto"
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="relative space-y-2 pointer-events-none">
